...
const EVENT = {
  ...
  hotel: {
    ...
    address:  'Kyrenia (Girne), Северный Кипр',
    phone:    '[+90 ...]',
    maps:     '',
    checkin:  '14:00',
    checkout: '12:00',
...
const HOTEL = {
  ...
  checkin:  '14:00',
  checkout: '12:00',
  breakfast: 'Главный ресторан · 07:30–10:00 · включён в программу',
  desc:    '5-звёздочный курортный отель на берегу Средиземного моря в Кирении. Собственный пляж, несколько бассейнов, СПА-центр и современные конференц-залы для деловой программы GCC 2026.',
  amenities: [
