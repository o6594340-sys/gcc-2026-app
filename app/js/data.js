...
const EXHIBITORS = [
  ...
  { id: 28, company: 'GreenCode International',    flag: '',    logoEmoji: '🌿', website: 'https://greencode.travel',                                                                                              contact: 'Maria Kots',                              phone: '', telegram: '', whatsapp: '', desc: 'Организатор GCC 2026 — DMC-компания, специализирующаяся на корпоративных инсентив-турах и MICE-мероприятиях. Создают программы под ключ: от концепции и логистики до проведения мероприятия.' },
