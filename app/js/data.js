...
const EXHIBITORS = [
  { id:  1, company: 'Calista Luxury Resort',        logoEmoji: '🏨', contact: 'Batuhan Kısa',                            phone: '', telegram: '', whatsapp: '', desc: 'Первый в Турции отель с международной наградой «Зелёная звезда» — 120 000 м² среди соснового леса в Белеке прямо у Средиземного моря. Концепция Ultra All Inclusive и ежегодные международные награды за качество сервиса.' },
  { id:  2, company: 'Conrad Istanbul Bosphorus',    logoEmoji: '🏨', contact: 'Işil Hünler',                             phone: '', telegram: '', whatsapp: '', desc: 'Пятизвёздочный отель на берегу Босфора с панорамными видами на пролив и исторические мосты Стамбула. Spa Soul, крытый и открытый бассейны, теннисный клуб и рестораны с авторской кухней.' },
  { id:  3, company: 'Crowne Plaza Belgrade',        logoEmoji: '🏨', contact: 'Martina Lazic',                           phone: '', telegram: '', whatsapp: '', desc: 'Флагманский отель в деловом районе Нового Белграда, в 15 минутах от аэропорта и в пешей доступности от Stark Arena. Крупнейший в городе бальный зал, 14 конференц-залов и ресторан Prime с авторской сербской кухней.' },
  { id:  4, company: 'CVK Hotels & Resorts',         logoEmoji: '🏨', contact: 'Timur Tajiyev',                           phone: '', telegram: '', whatsapp: '', desc: 'Турецкая luxury-сеть в центре Стамбула: флагман CVK Park Bosphorus Hotel — крупнейший гостиничный инвестиционный проект в истории города. 68 апартаментов-люксов, безупречный spa и центральное расположение.' },
  { id:  5, company: 'Doria Hotel Bodrum',           logoEmoji: '🏨', contact: 'İpek Gaye Sungur',                        phone: '', telegram: '', whatsapp: '', desc: 'Boutique-отель с видом на бухту Битез в Бодруме, работающий круглый год и отражающий живой дух Эгейского моря в каждой детали. Современный дизайн и элегантная простота в одном из самых живописных мест Турции.' },
  { id:  6, company: 'Ducale Lara',                  logoEmoji: '🏨', contact: 'Fırat Sakarya',                           phone: '', telegram: '', whatsapp: '', desc: 'Уникальный Ultra All Inclusive отель в Анталье, где на берегу Средиземного моря воссозданы площадь Сан-Марко, Дворец Дожей и мост Риальто из Венеции. Масштабный архитектурный ансамбль, поражающий деталировкой и атмосферой.' },
  { id:  7, company: 'Ela Excellence Resort Belek',  logoEmoji: '🏨', contact: 'Seda Gürgen',                             phone: '', telegram: '', whatsapp: '', desc: 'Пятизвёздочный resort в первой береговой линии Белека с номерами в современном минималистичном стиле у самого моря. Длинный песчаный пляж, открытые бассейны, аквапарк и рестораны с изысканной кухней для отдыха любого возраста.' },
  { id:  8, company: 'Ethno Hotels',                 logoEmoji: '🏨', contact: 'Mariia Andrieieva, Şeyda Kara',           phone: '', telegram: '', whatsapp: '', desc: 'Культурный resort-концепт в Белеке, где традиции, ритуалы и истории разных народов мира соединяются в живую мозаику. Ethno Culture превращает каждое пребывание в уникальное путешествие между цивилизациями.' },
  { id:  9, company: 'Gloria Hotels & Resorts',      logoEmoji: '🏨', contact: 'Ali Doğuş Tanyıldız, Gökhan Gümüşdede',  phone: '', telegram: '', whatsapp: '', desc: 'Легендарная гостиничная группа Белека с историей с 1997 года: Gloria Golf Resort, Verde Resort и Serenity Resort. Идеальное сочетание luxury-отдыха, гольфа мирового уровня и семейного сервиса на Средиземном море.' },
  { id: 10, company: 'KHG (Nirvana Hotels)',          logoEmoji: '🏨', contact: 'Merve Demir',                             phone: '', telegram: '', whatsapp: '', desc: 'Группа KHG управляет тремя концептуальными отелями бренда Nirvana: Mediterranean Excellence в сосновом лесу, Cosmopolitan с городским ритмом и Dolce Vita с приватной бухтой у Таврских гор. Три разных мира отдыха — одна философия сервиса.' },
  { id: 11, company: 'Le Meridien Istanbul Etiler',  logoEmoji: '🏨', contact: 'Meltem Doğanok',                          phone: '', telegram: '', whatsapp: '', desc: '34-этажный 5-звёздочный отель в Стамбуле с панорамными видами на Босфор и мосты города из каждого из 255 номеров. Более 2 500 м² event-пространств, турецкий хаммам и открытый бассейн.' },
  { id: 12, company: 'MATCH POINT',                  logoEmoji: '🤝', contact: 'Daria Ignatieva',                         phone: '', telegram: '', whatsapp: '', desc: 'Маркетинговое представительство ведущих DMC в Омане, Катаре, Японии, Вьетнаме и Китае. Надёжный партнёр для организации MICE-мероприятий в наиболее востребованных направлениях Ближнего Востока и Азии.' },
  { id: 13, company: 'NG Hotels',                    logoEmoji: '🏨', contact: 'Salih Aygün, Mert Gunur Bertan',          phone: '', telegram: '', whatsapp: '', desc: 'Один из ведущих luxury-брендов Турции: курорты NG Sapanca, NG Enjoy, NG Afyon и NG Phaselis Bay — каждый с уникальной концепцией и природным окружением. Изысканная гастрономия, wellness и high-end event-инфраструктура.' },
  { id: 14, company: "Princes' Palace Resort",       logoEmoji: '🏨', contact: 'Engin Alper',                             phone: '', telegram: '', whatsapp: '', desc: 'Уединённый luxury-курорт на Принцевых островах близ Стамбула, где особняк XIX века переосмыслен в духе современной роскоши. Приватная пляжная лагуна, infinity-бассейны и ANIM Wellbeing & Spa.' },
  { id: 15, company: 'REGNUM Hotels',                logoEmoji: '🏨', contact: 'Burhan Alperen Aslan, Esra Köseoğlu',     phone: '', telegram: '', whatsapp: '', desc: 'Regnum Carya и Regnum The Crown — два premier-отеля в Белеке с философией устойчивого развития и персонализированного сервиса. Regnum The Crown открывает виды на Средиземное море с Rooftop-террасы.' },
  { id: 16, company: 'RIXOS Egypt',                  logoEmoji: '🏨', contact: 'Uğur Can Dilsiz',                         phone: '', telegram: '', whatsapp: '', desc: 'Часть группы Accor, Rixos Egypt объединяет iconic resort-отели на Красном и Средиземном морях — от adults-only концепций до семейных курортов. Фирменный All Inclusive сочетает luxury-стандарты, гастрономию и яркие развлечения.' },
  { id: 17, company: 'Sacred Mansion',               logoEmoji: '🏨', contact: 'Leyla Aydin',                             phone: '', telegram: '', whatsapp: '', desc: 'Boutique luxury-отель в пещерной архитектуре Каппадокии с 37 уникальными номерами и интерьерами в стиле арт-галереи — с видом на воздушные шары над Гёреме. Легендарный Inferno SPA с Red Pool и ресторан Lilith.' },
  { id: 18, company: 'Sheraton Istanbul Levent',     logoEmoji: '🏨', contact: 'Selma Yılmaz Patat',                      phone: '', telegram: '', whatsapp: '', desc: 'Современный отель и spa-комплекс в деловом районе Левент, в шаговой доступности от ключевых бизнес-хабов Стамбула. Shine Spa, уютный сад в сердце города и ресторан The Levantino с кухней Восточного Средиземноморья.' },
  { id: 19, company: 'Silk Hospitality',             logoEmoji: '🏢', contact: 'Sophio Meskhi',                           phone: '', telegram: '', whatsapp: '', desc: 'Ведущий гостиничный оператор Грузии с 7 объектами мирового уровня в Тбилиси, Батуми, Цинандали и Кохта. Портфель включает upscale-отели, luxury-казино и рестораны под ведущими международными брендами.' },
  { id: 20, company: 'Sinnada Resort & Thermaland',  logoEmoji: '🏨', contact: 'Merih Gülmez',                            phone: '', telegram: '', whatsapp: '', desc: 'Первый в Турции термальный SPA-отель с тропической концепцией: 19 850 м² с 280 пальмами, термальными бассейнами и ощущением лета круглый год. Три коллекции размещения для разных потребностей — от wellness до эксклюзивного отдыха.' },
  { id: 21, company: 'Sueno Hotels',                 logoEmoji: '🏨', contact: 'Araz Hadi, Cihan Şengül',                 phone: '', telegram: '', whatsapp: '', desc: 'Luxury all-inclusive resort в Белеке, где традиционное турецкое гостеприимство встречается с роскошью Средиземного моря. Уникальные гольф-поля, семейные активности и exclusive spa для пар — всё под одной крышей.' },
  { id: 22, company: 'Susesi Luxury Resort',         logoEmoji: '🏨', contact: 'Şefika Uluçay',                           phone: '', telegram: '', whatsapp: '', desc: 'Flagship luxury resort в Белеке с обновлёнными номерами, авторским спа-центром и ресторанами мировой кухни с живой музыкой. Каждая деталь Susesi создана для того, чтобы каждый момент отдыха был особенным.' },
  { id: 23, company: 'Wyndham Grand Tbilisi',        logoEmoji: '🏨', contact: 'Ana Chechelashvili, Manana Ashadze',      phone: '', telegram: '', whatsapp: '', desc: '5-звёздочный отель в самом центре Тбилиси, в нескольких шагах от площади Свободы и Старого города. Более 906 м² event-пространств и ballroom с панорамным видом на 9-м этаже — идеально для MICE-мероприятий до 330 гостей.' },
];
