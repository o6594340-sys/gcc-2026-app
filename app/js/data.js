...
const EXHIBITORS = [
  ...
  { id:  8, company: 'Ethno Hotels',                 flag: '🇹🇷', logoEmoji: '🏨', website: 'https://www.ethnohotels.com/en',                                                                                     contact: 'Mariia Andrieieva, Şeyda Kara, Bora Hazinecioğlu',           phone: '', telegram: '', whatsapp: '', desc: 'Культурный resort-концепт в Белеке, где традиции, ритуалы и истории разных народов мира соединяются в живую мозаику. Ethno Culture превращает каждое пребывание в уникальное путешествие между цивилизациями.' },
