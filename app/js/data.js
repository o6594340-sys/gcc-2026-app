...
const DAYS = [
  ...
  },
  {
    ...
    activities: [
      ...
      { time: '09:30',       title: 'Трансфер · TK 977', location: 'Главный вход отеля', type: 'transfer', note: 'Вылет 12:30 · 1 Vito' },
      { time: '11:10',       title: 'Трансфер · PC 1917', location: 'Главный вход отеля', type: 'transfer', note: 'Вылет 14:10 · 1 Sprinter' },
      { time: '12:05',       title: 'Трансфер · PC 1873', location: 'Главный вход отеля', type: 'transfer', note: 'Вылет 15:05 · 1 Vito' },
      { time: '12:40',       title: 'Трансфер · TK 969', location: 'Главный вход отеля', type: 'transfer', note: 'Вылет 15:40 · 1 Vito' },
      { time: '13:00',       title: 'Трансфер · Пафос', location: 'Главный вход отеля', type: 'transfer', note: '1 Vito · 3 пассажира' },
      { time: '16:00',       title: 'Трансфер · TK 967', location: 'Главный вход отеля', type: 'transfer', note: 'Вылет 16:30 · 2 автобуса' },
      { time: '16:15',       title: 'Трансфер · TK 981', location: 'Главный вход отеля', type: 'transfer', note: 'Вылет 19:15 · 1 Sprinter + 1 Vito для багажа' },
      { time: '17:10',       title: 'Трансфер · PC 1923', location: 'Главный вход отеля', type: 'transfer', note: 'Вылет 20:10 · 1 Vito' },
      { time: '18:20',       title: 'Трансфер · PC 1925, VF 558', location: 'Главный вход отеля', type: 'transfer', note: 'Вылет 21:20 · 1 Sprinter' },
      { time: '19:15',       title: 'Трансфер · XQ 311, PC 1915', location: 'Главный вход отеля', type: 'transfer', note: 'Вылеты 22:15–22:25 · 1 Vito' },
    ],
  },
];
...
const EXHIBITORS = [
  { id:   1, table:  3, company: 'Calista Luxury Resort',        flag: '', logoEmoji: '🏨', website: 'https://calista.com.tr/en',                                                                                          contact: 'Batuhan Kısa',                            phone: '', telegram: '', whatsapp: '', desc: 'Первый в Турции отель с международной наградой «Зелёная звезда» — 120 000 м² среди соснового леса в Белеке прямо у Средиземного моря. Концепция Ultra All Inclusive и ежегодные международные награды за качество сервиса.' },
  { id:  24, table:  1, company: 'Concorde Luxury Resort & Beach Club & Casino', flag: '', logoEmoji: '🏨', website: 'https://concordehotels.com/en/otels/concorde-luxury-resort',                                                                             contact: 'Aziza Donmez, Daria Damar',               phone: '', telegram: '', whatsapp: '', desc: 'Отель расположен на побережье Северного Кипра, работает по системе «всё включено» и имеет благоустроенную территорию 125 000 м² с собственным песчаным пляжем и аквапарком. Среди ключевых особенностей - круглосуточное казино, одиннадцать баров с уникальной атмосферой и развитая инфраструктура для деловых мероприятий и конференций.' },
  { id:   2, table: 16, company: 'Conrad Istanbul Bosphorus',    flag: '', logoEmoji: '🏨', website: 'https://www.hilton.com/en/hotels/isthcci-conrad-istanbul-bosphorus/',                                               contact: 'Işil Hünler',                             phone: '', telegram: '', whatsapp: '', desc: 'Пятизвёздочный отель на берегу Босфора с панорамными видами на пролив и исторические мосты Стамбула. Spa Soul, крытый и открытый бассейны, теннисный клуб и рестораны с авторской кухней.' },
  { id:   3, table: 23, company: 'Crowne Plaza Belgrade',        flag: '', logoEmoji: '🏨', website: 'https://www.ihg.com/crowneplaza/hotels/us/en/belgrade/begcp/hoteldetail',                                           contact: 'Martina Lazic',                           phone: '', telegram: '', whatsapp: '', desc: 'Флагманский отель в деловом районе Нового Белграда, в 15 минутах от аэропорта и в пешей доступности от Stark Arena. Крупнейший в городе бальный зал, 14 конференц-залов и ресторан Prime с авторской сербской кухней.' },
  ...
  { id:   8, table: 13, company: 'Ethno Belek',                 flag: '', logoEmoji: '🏨', website: 'https://www.ethnohotels.com/en',                                                                                     contact: 'Mariia Andrieieva, Şeyda Kara, Bora Hazinecioğlu',           phone: '', telegram: '', whatsapp: '', desc: 'Культурный resort-концепт в Белеке, где традиции, ритуалы и истории разных народов мира соединяются в живую мозаику. Ethno Culture превращает каждое пребывание в уникальное путешествие между цивилизациями.' },
  ...
  { id:  28, table: null, company: 'GreenCode International',    flag: '',    logoEmoji: '🌿', website: 'https://greencode.travel',                                                                                              contact: 'Maria Kots, Ismayil Samadov, Iraklii Kedia',                              phone: '', telegram: '', whatsapp: '', desc: 'Организатор GCC 2026 — DMC-компания, специализирующаяся на корпоративных инсентив-турах и MICE-мероприятиях. Создают программы под ключ: от концепции и логистики до проведения мероприятия.' },
  { id:  10, table: 25, company: 'KHG (Nirvana Hotels)',          flag: '', logoEmoji: '🏨', website: 'https://www.nirvanahotels.com.tr/en/',                                                                               contact: 'Merve Demir',                             phone: '', telegram: '', whatsapp: '', desc: 'Группа KHG управляет тремя концептуальными отелями бренда Nirvana: Mediterranean Excellence в сосновом лесу, Cosmopolitan с городским ритмом и Dolce Vita с приватной бухтой у Таврских гор. Три разных мира отдыха — одна философия сервиса.' },
  { id:  11, table: 27, company: 'Le Meridien Istanbul Etiler',  flag: '', logoEmoji: '🏨', website: 'https://www.marriott.com/en-us/hotels/istmd-le-meridien-istanbul-etiler/overview/',                                  contact: 'Meltem Doğanok',                          phone: '', telegram: '', whatsapp: '', desc: '34-этажный 5-звёздочный отель в Стамбуле с панорамными видами на Босфор и мосты города из каждого из 255 номеров. Более 2 500 м² event-пространств, турецкий хаммам и открытый бассейн.' },
  { id:  25, table:  8, company: 'Limak Cyprus Deluxe Hotel', flag: '', logoEmoji: '🏨', website: 'https://www.limakhotels.com/tr/cyprus',                                                                                 contact: 'Nazlı Kağan, Yasin Genç, Ayşenur Kavaloğlu',                             phone: '', telegram: '', whatsapp: '', desc: 'Отель расположен на побережье Северного Кипра (район Бафра) и работает по системе «ультра всё включено» с собственным песчаным пляжем. На территории есть аквапарк с горками, несколько ресторанов (шведский стол и à la carte), бары, спа-центр и фитнес-зал.' },
  { id:  26, table:  6, company: "Lord's Palace Hotel",            flag: '', logoEmoji: '🏨', website: 'https://lordspalace.com/en/',                                                                                        contact: 'Gonca Saltik, Ekren Misra',                            phone: '', telegram: '', whatsapp: '', desc: 'Пятизвёздочный отель Casino & SPA на берегу Средиземного моря в Анталье с 250 номерами с видами на море, горы и город. Rooftop-терраса с бассейном, современный спа-центр и конференц-залы для корпоративных групп.' },
  { id:  12, table:  7, company: 'MATCH POINT',                  flag: '',    logoEmoji: '🤝', website: 'https://matchpoints.ru/english',                                                                                     contact: 'Daria Ignatieva',                         phone: '', telegram: '', whatsapp: '', desc: 'Маркетинговое представительство ведущих DMC в Омане, Катаре, Японии, Вьетнаме и Китае. Надёжный партнёр для организации MICE-мероприятий в наиболее востребованных направлениях Ближнего Востока и Азии.' },
  { id:  27, table:  5, company: 'Merit Park Hotel',               flag: '', logoEmoji: '🏨', website: 'https://www.merithotels.com/en/merit-park-hotel',                                                                    contact: 'Gürkan Cihan, Atam Fidan Yılmaz',                            phone: '', telegram: '', whatsapp: '', desc: 'Пятизвёздочный resort на набережной Кирении — флагманский объект группы Merit Hotels на Северном Кипре, с casino и полным спа-комплексом. 273 реновированных номера и конференц-залы для MICE-мероприятий.' },
  { id:  13, table: 24, company: 'NG Phaselis Bay',                    flag: '', logoEmoji: '🏨', website: 'https://ngphaselisbay.com/en/',                                                                                    contact: 'Salih Aygün, Mert Gunur Bertan',          phone: '', telegram: '', whatsapp: '', desc: 'Один из ведущих luxury-брендов Турции: курорты NG Sapanca, NG Enjoy, NG Afyon и NG Phaselis Bay — каждый с уникальной концепцией и природным окружением. Изысканная гастрономия, wellness и high-end event-инфраструктура.' },
  { id:  14, table:  2, company: "Princes' Palace Resort",       flag: '', logoEmoji: '🏨', website: 'https://princespalace.com/',                                                                                         contact: 'Engin Alper',                             phone: '', telegram: '', whatsapp: '', desc: 'Уединённый luxury-курорт на Принцевых островах близ Стамбула, где особняк XIX века переосмыслен в духе современной роскоши. Приватная пляжная лагуна, infinity-бассейны и ANIM Wellbeing & Spa.' },
  { id:  15, table: 11, company: 'REGNUM Hotels',                flag: '', logoEmoji: '🏨', website: 'https://www.regnumhotels.com/en/',                                                                                   contact: 'Burhan Alperen Aslan, Esra Köseoğlu',     phone: '', telegram: '', whatsapp: '', desc: 'Regnum Carya и Regnum The Crown — два premier-отеля в Белеке с философией устойчивого развития и персонализированного сервиса. Regnum The Crown открывает виды на Средиземное море с Rooftop-террасы.' },
  { id:  16, table: 20, company: 'RIXOS Egypt',                  flag: '', logoEmoji: '🏨', website: 'https://www.rixos.com/destinations/egypt',                                                                           contact: 'Uğur Can Dilsiz',                         phone: '', telegram: '', whatsapp: '', desc: 'Часть группы Accor, Rixos Egypt объединяет iconic resort-отели на Красном и Средиземном морях — от adults-only концепций до семейных курортов. Фирменный All Inclusive сочетает luxury-стандарты, гастрономию и яркие развлечения.' },
  { id:  17, table: 22, company: 'Sacred Mansion',               flag: '', logoEmoji: '🏨', website: 'https://sacredmansion.com.tr/',                                                                                      contact: 'Leyla Aydin',                             phone: '', telegram: '', whatsapp: '', desc: 'Boutique luxury-отель в пещерной архитектуре Каппадокии с 37 уникальными номерами и интерьерами в стиле арт-галереи — с видом на воздушные шары над Гёреме. Легендарный Inferno SPA с Red Pool и ресторан Lilith.' },
  { id:  18, table: 28, company: 'Sheraton Istanbul Levent',     flag: '', logoEmoji: '🏨', website: 'https://www.istanbulsheratonlevent.com/',                                                                            contact: 'Selma Yılmaz Patat',                      phone: '', telegram: '', whatsapp: '', desc: 'Современный отель и spa-комплекс в деловом районе Левент, в шаговой доступности от ключевых бизнес-хабов Стамбула. Shine Spa, уютный сад в сердце города и ресторан The Levantino с кухней Восточного Средиземноморья.' },
  { id:  19, table:  9, company: 'Silk Hospitality',             flag: '', logoEmoji: '🏢', website: 'https://silkhospitality.com/',                                                                                       contact: 'Sophio Meskhi',                           phone: '', telegram: '', whatsapp: '', desc: 'Ведущий гостиничный оператор Грузии с 7 объектами мирового уровня в Тбилиси, Батуми, Цинандали и Кохта. Портфель включает upscale-отели, luxury-казино и рестораны под ведущими международными брендами.' },
  { id:  20, table: 21, company: 'Sinnada Resort & Thermaland',  flag: '', logoEmoji: '🏨', website: 'https://sinnada.com/en',                                                                                             contact: 'Merih Gülmez',                            phone: '', telegram: '', whatsapp: '', desc: 'Первый в Турции термальный SPA-отель с тропической концепцией: 19 850 м² с 280 пальмами, термальными бассейнами и ощущением лета круглый год. Три коллекции размещения для разных потребностей — от wellness до эксклюзивного отдыха.' },
  { id:  21, table: 10, company: 'Sueno Hotels',                 flag: '', logoEmoji: '🏨', website: 'https://sueno.com.tr/anasayfa-en/',                                                                                  contact: 'Araz Hadi, Cihan Şengül',                 phone: '', telegram: '', whatsapp: '', desc: 'Luxury all-inclusive resort в Белеке, где традиционное турецкое гостеприимство встречается с роскошью Средиземного моря. Уникальные гольф-поля, семейные активности и exclusive spa для пар — всё под одной крышей.' },
  { id:  22, table: 12, company: 'Susesi Luxury Resort',         flag: '', logoEmoji: '🏨', website: 'https://www.susesihotel.com/en/',                                                                                    contact: 'Şefika Uluçay',                           phone: '', telegram: '', whatsapp: '', desc: 'Flagship luxury resort в Белеке с обновлёнными номерами, авторским спа-центром и ресторанами мировой кухни с живой музыкой. Каждая деталь Susesi создана для того, чтобы каждый момент отдыха был особенным.' },
  { id:  23, table: 14, company: 'Wyndham Grand Tbilisi',        flag: '', logoEmoji: '🏨', website: 'https://www.wyndhamhotels.com/wyndham-grand/tbilisi-georgia/wyndham-grand-tbilisi/overview',                        contact: 'Ana Chechelashvili, Manana Ashadze',      phone: '', telegram: '', whatsapp: '', desc: '5-звёздочный отель в самом центре Тбилиси, в нескольких шагах от площади Свободы и Старого города. Более 906 м² event-пространств и ballroom с панорамным видом на 9-м этаже — идеально для MICE-мероприятий до 330 гостей.' },
];
...
const WORKSHOP_TABLES = [
  ...
  { table: 15, company: 'MSC Cruises · PAC Group' },
  ...
  { table: 27, company: 'Le Méridien Istanbul Etiler' },
...
{ q: 'Can I go into town?',                        a: 'Yes, during free time — Kyrenia is right there. Places and distances are listed in the Location tab.' },
    ...
    exhibitors: [
      ...
      { desc: 'Located on the coast of Northern Cyprus, the hotel operates on an all-inclusive basis and features a beautifully landscaped 125,000 m² area with a private sandy beach and a water park. Key highlights include a 24-hour casino, eleven bars with a unique atmosphere, and extensive facilities for business events and conferences.' },
      ...
      { desc: 'The hotel is located on the coast of Northern Cyprus (Bafra region) and operates on an "ultra all-inclusive" system with its own sandy beach. The property features a water park with slides, several restaurants (buffet and à la carte), bars, a spa center, and a gym.' },
