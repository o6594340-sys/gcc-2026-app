...
const EXHIBITORS = [
  ...
  { id: 24, company: 'Concorde De Luxe Resort',       flag: '', logoEmoji: '🏨', website: 'https://concordehotels.com/tr/oteller/concorde-tower-hotel',                                                                             contact: 'Aziza Donmez, Daria Damar',               phone: '', telegram: '', whatsapp: '', desc: 'Тематический пятизвёздочный resort на первой береговой линии Лары, архитектурно выполненный в форме самолёта Конкорд, с прямым выходом на пляж с Голубым флагом. 380 номеров с балконами, 11 ресторанов и конференц-залы для мероприятий.' },
