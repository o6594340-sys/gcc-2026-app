...
const EXHIBITORS = [
  ...
  { id: 24, company: 'Concorde Luxury Resort & Beach Club & Casino', flag: '', logoEmoji: '🏨', website: 'https://concordehotels.com/en/otels/concorde-luxury-resort',                                                                             contact: 'Aziza Donmez, Daria Damar',               phone: '', telegram: '', whatsapp: '', desc: 'Тематический пятизвёздочный resort на первой береговой линии Лары, архитектурно выполненный в форме самолёта Конкорд, с прямым выходом на пляж с Голубым флагом. 380 номеров с балконами, 11 ресторанов и конференц-залы для мероприятий.' },
